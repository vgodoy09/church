...
<body>
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Configuração Usuario</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                             	<form role="form" name="form" action="ControleUsuario" method="post">
                                	<div class="col-lg-6">
	                                    ...
	                                    <div class="form-group text-right" style="margin-top:0px;">
		                                	<input type="submit" class="btn btn-default" name="btnAlterar" value="Alterar" />
		                                </div>                                        
	                                </div>
	                                <!-- /.col-lg-6 (nested) -->
	                                <div class="col-lg-6">
