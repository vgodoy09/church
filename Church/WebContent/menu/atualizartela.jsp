...
<body>
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Atualizar Telas</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <div class="panel-body">
                            <div class="row">
                             	<form role="form" name="form" action="ControleTela" method="post">
                                	<div class="col-lg-6">
                                		<input type="hidden" name="txtid" value="${tel.id}" />
                                        <div class="form-group">
                                            <label>Nome da Tela</label>
                                            <input class="form-control" placeholder="Nome" name="name" value="${tel.name}" autofocus>
                                            <p class="help-block">Coloque o Nome da Tela Exemplo: cadastro da tela.</p>
                                        </div>
                                        <div class="form-group">
                                            <label>Nome do Arquivo</label>
                                            <input class="form-control" placeholder="Nome" name="filename" value="${tel.filename}">
