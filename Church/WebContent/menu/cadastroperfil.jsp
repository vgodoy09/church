...
<body>
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Cadastrar Perfis</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			                                    ...
			                                    <tbody>
			                                    	<c:forEach items="${listarM}" var="men">
														<tr class="treegrid-${men.id}">
															<td><input type="checkbox" name="idmen" value="${men.id}"/></td>
														...
														<c:if test="${not empty men.listmenu}">
															<c:forEach items="${men.listmenu}" var="submen">
																<tr class="treegrid-${submen.id} treegrid-parent-${men.id}">
																	<td><input type="checkbox" name="idsubmen" value="${submen.id}"/></td>
																...
																<c:if test="${not empty men.listmenu}">
																	<c:forEach items="${men.listmenu}" var="submen1">
																		<tr class="treegrid-${submen1.id} treegrid-parent-${submen.id}">
																			<td><input type="checkbox" name="idsubmen1" value="${submen1.id}"/></td>
