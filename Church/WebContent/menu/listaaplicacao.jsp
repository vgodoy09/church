...
<body>
	...
	<div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Listar Aplicações</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
	                                ...
	                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
	                                    ...
	                                    <tbody>
											<c:forEach items="${listarAplicacoes}" var="app">
		                                        <tr class="odd gradeC" onclick="location.href = 'ControleApplication?antesAtualizar=&id=${app.id}';">
			                                        	<td>${app.id}</td>
			                                            <td>${app.nome}</td>
			                                            <td>${app.imageLogoAvailable}</td>
			                                            <td>${app.imageLogoUnavailable}</td>
			                                            <td>${app.link}</td>
			                                            <td>${app.messageUserActivation}</td>
		                                        </tr>
		                               		</c:forEach>         
	                                    </tbody>
	                                </table>
